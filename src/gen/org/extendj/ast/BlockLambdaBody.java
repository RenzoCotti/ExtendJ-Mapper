...
/**
 * @ast node
 * @declaredat /Users/BMW/Downloads/extendj/java8/grammar/Lambda.ast:12
...
public class BlockLambdaBody extends LambdaBody implements Cloneable {
   ...
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/PrettyPrint.jadd:39
   */
   ...
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/LambdaAnonymousDecl.jrag:79
   */
   ...
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:57
   */
  ...
  /**
   * @aspect ReturnCompatible
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:67
   */
   ...
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/EffectivelyFinal.jrag:43
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="PreciseRethrow", declaredAt="/Users/BMW/Downloads/extendj/java8/frontend/EffectivelyFinal.jrag:43")
   ...
   * @attribute syn
   * @aspect LambdaBody
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:29
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="LambdaBody", declaredAt="/Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:29")
   ...
   * @attribute syn
   * @aspect LambdaBody
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:30
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="LambdaBody", declaredAt="/Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:30")
   ...
   * @attribute syn
   * @aspect ReturnCompatible
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:40
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="ReturnCompatible", declaredAt="/Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:40")
   ...
   * @attribute syn
   * @aspect ReturnCompatible
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:41
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="ReturnCompatible", declaredAt="/Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:41")
   ...
   * @attribute syn
   * @aspect LambdaExpr
   * @declaredat /Users/BMW/Downloads/extendj/java8/frontend/LambdaExpr.jrag:74
   */
  @ASTNodeAnnotation.Attribute(kind=ASTNodeAnnotation.Kind.SYN)
  @ASTNodeAnnotation.Source(aspect="LambdaExpr", declaredAt="/Users/BMW/Downloads/extendj/java8/frontend/LambdaExpr.jrag:74")
  ...
  public boolean Define_assignmentContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getBlockNoTransform() != null && _callerNode == getBlock()) {
      // @declaredat /Users/BMW/Downloads/extendj/java8/frontend/TargetType.jrag:213
      return false;
    }
    else {
  ...
  public boolean Define_invocationContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getBlockNoTransform() != null && _callerNode == getBlock()) {
      // @declaredat /Users/BMW/Downloads/extendj/java8/frontend/TargetType.jrag:214
      return false;
    }
    else {
  ...
  public boolean Define_castContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getBlockNoTransform() != null && _callerNode == getBlock()) {
      // @declaredat /Users/BMW/Downloads/extendj/java8/frontend/TargetType.jrag:215
      return false;
    }
    else {
  ...
  public boolean Define_stringContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getBlockNoTransform() != null && _callerNode == getBlock()) {
      // @declaredat /Users/BMW/Downloads/extendj/java8/frontend/TargetType.jrag:216
      return false;
    }
    else {
  ...
  public boolean Define_numericContext(ASTNode _callerNode, ASTNode _childNode) {
    if (getBlockNoTransform() != null && _callerNode == getBlock()) {
      // @declaredat /Users/BMW/Downloads/extendj/java8/frontend/TargetType.jrag:217
      return false;
    }
    else {
  ...
  @ASTNodeAnnotation.Source(aspect="ReturnCompatible", declaredAt="/Users/BMW/Downloads/extendj/java8/frontend/LambdaBody.jrag:47")
  ...
  protected void collect_contributors_CompilationUnit_problems(CompilationUnit _root, java.util.Map<ASTNode, java.util.Set<ASTNode>> _map) {
    // @declaredat /Users/BMW/Downloads/extendj/java8/frontend/TypeCheck.jrag:195
