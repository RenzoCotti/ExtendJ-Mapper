...
/**
 * @ast node
 * @declaredat /Users/BMW/Downloads/extendj/java5/grammar/Generics.ast:45
  ...
  public MethodDecl nonWildcardParameterization() {
    {
        ...
        TypeDecl param = host.nonWildcardParameterization();
        if (param == null) {
        ...
        if (param == host) {
          ...
          for (BodyDecl decl : param.getBodyDeclList()) {
            if (decl.isSubstitutionOf(this.sourceMethodDecl())) {
              return (MethodDecl) decl;
            }
          }
          // This should not happen.
          throw new Error("Did not find matching substituted method.");
        }
      }
  }
  /**
