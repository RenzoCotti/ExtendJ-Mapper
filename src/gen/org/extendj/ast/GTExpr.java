...
/**
 * @ast node
 * @declaredat /Users/BMW/Downloads/extendj/java4/grammar/Java.ast:176
...
public class GTExpr extends RelationalExpr implements Cloneable {
  /**
   * @aspect CreateBCode
   * @declaredat /Users/BMW/Downloads/extendj/java4/backend/CreateBCode.jrag:1817
   */
  public <E extends TraceElement<S>, S> NodeValueList compareBranch(
			...
			String contextMsg
			, TypeDecl typeDecl) {
	  return typeDecl.branchGT(trace, generator, contextMsg);
  }
  /**
   * @aspect CreateBCode
   * @declaredat /Users/BMW/Downloads/extendj/java4/backend/CreateBCode.jrag:1825
   */
  public void compareBranch(CodeGeneration gen, int label, TypeDecl typeDecl) {
    typeDecl.branchGT(this, gen, label);
  }
  /**
   * @aspect CreateBCode
   * @declaredat /Users/BMW/Downloads/extendj/java4/backend/CreateBCode.jrag:1904
   */
  public <E extends TraceElement<S>, S> NodeValueList compareNotBranch(
			...
			String contextMsg
			, TypeDecl typeDecl) {
	  return typeDecl.branchLEInv(trace, generator, contextMsg);
  }
  /**
   * @aspect CreateBCode
   * @declaredat /Users/BMW/Downloads/extendj/java4/backend/CreateBCode.jrag:1912
   */
  public void compareNotBranch(CodeGeneration gen, int label, TypeDecl typeDecl) {
    typeDecl.branchLEInv(this, gen, label);
  }
  /**
